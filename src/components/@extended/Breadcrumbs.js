...
const Breadcrumbs = ({
  ...
  const isCreate = currentPath.includes('/createNewShipment');
  const isEditShipment = currentPath.includes('/editShipment');
  const isCreateManifest = currentPath.includes('/manifestShipment/create');
  const isEditManifest = currentPath.includes('/manifestShipment/edit');
