    ...
    <>
      ...
      >
        ...
        <Grid item xs={12} sx={{ height: '100%' }}>
          <Stack spacing={2} justifyContent="center" alignItems="center" sx={{ position: 'relative' }}>
            ...
            <Box sx={{ position: 'absolute', top: '-60%', left: '-35%', width: { xs: 130, sm: 390 }, height: { xs: 115, sm: 330 } }}>
              <img src={TwoCone} alt="mantis" style={{ width: '100%', height: '100%' }} />
            </Box>
          </Stack>
        </Grid>
