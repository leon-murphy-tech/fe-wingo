...
// assets
import { BellOutlined, CheckCircleOutlined, CheckOutlined, GiftOutlined, MessageOutlined, SettingOutlined } from '@ant-design/icons';
            ...
            >
              <ClickAwayListener onClickAway={handleClose}>
                ...
                >
                  ...
                  >
                    {notiList?.slice(0, 4)?.map((item) => (
                      <>
                        <ListItemButton selected={read > 0} key={item.id}>
                          {/* <ListItemAvatar>
                            <Avatar
                              sx={{
                                color: 'success.main',
